...
<%--
* @Description : 다음 지도 API를 이용한 개인 거래처 확인 페이지 
* @author 문성철
* @version 1.0
* @since 2017. 5. 2.
*
...
<section class="content">
		<div class="box">	
			<!-- box-body -->
			<div class="box-body">
				<!-- 개인 거래처 조회를위해 hidden 값 설정 -->
				<input type="hidden" id="mem_id" value="${member.mem_id}">
				<input type="hidden" id="mem_nm" value="${member.mem_nm}">
				<!-- 지도가 표시되는 div -->
    ...
    function getTexts( count ) {
      ...
      if(count < 10) {
   	...
   	$.ajax({
   	    ...
   	    console.log("Ajax  거래처 현황 조회(개인의 거래처의 정보) 가져오기 성공")
