...
<section class="content-header">
	...
	<ol class="breadcrumb">
	  <li><a href="#"><i class="fa fa-dashboard"></i> 부서표준문서</a></li>
	  <li class="active">부서표준문서목록</li>
	</ol>
</section>
<style>
...
<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/doc/css/doc.css" >
        ...
        <div class="modal modal-primary" id="insertFile"  role="dialog">
         ...
         <!-- 멀티 파일업로드 -->
				...
				<input type="hidden" name="division" value="dept">
       ...
       <script src="${pageContext.request.contextPath }/resources/doc/js/deptDoc.js"></script> 
