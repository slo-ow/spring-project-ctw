...
<div class="box">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
				  ...
				  <select class="form-control"  name="division" >
				    <option value="mem">개인일정</option>
				    <option value="dept">부서일정</option>
				    <c:if test="${member.grad_pk > 5}">
				    <option value="com">회사일정</option>
				    </c:if>
				  </select>
				</div>
     ...
     <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div>
              		...
              		<input type="hidden" name="division" id="divi">
 ...
 <script src="${pageContext.request.contextPath }/resources/calendar/js/comCal.js"></script>
