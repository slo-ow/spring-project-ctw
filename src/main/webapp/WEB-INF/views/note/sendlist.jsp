...
<section class="content">
	...
	<div class="box">
		...
		<!-- 게시판 목록 리스트 -->
			...
			<input type="hidden" id="division" value="dspt">
	</div>
</section>    
			...
			<div class="modal-dialog modal-lg">
				...
				<form action="mssInsert" id="insert" method="post" enctype="multipart/form-data">	 
              	<div class="form-group">
              		...
              		<div class="col-sm-2">
              			<input type="button" id="registerBtn" class="btn btn-default" data-toggle="modal" data-target="#memList" value="사원목록" />
              			<br><br>
              		</div>
              	</div>
              	<br>
		...
		<!-- 사원목록보기 modal -->
		<div class="modal fade" id="memList" role="dialog"  role="dialog" data-toggle="modal" data-backdrop="static" data-keyboard="false" >
			<div class="modal-dialog modal-lg" style="width: 300px; margin: 0 auto;">

				<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" onclick="memCancel();">&times;</button>
						<h4 class="modal-title">사원목록</h4>
					</div>
					<div class="modal-body">
						<div class="container">
							<label>부서선택</label>
							<select class="form-control" id="dept" style="width: 230px;">
					
							</select>
						</div>			 
   				
	                 	<div class="container">
	              			<div id="memberList" style=""> </div>
	              		</div>
	              		<div class="container">
	              		<input type="text" class="form-control fakeId" id="mssMember" name="" placeholder="사원을 선택해주세요" readonly="readonly" style="width: 230px;">
						</div>	
					</div>
					<div class="modal-footer">
						<div class="col-sm-offset-2 col-sm-10">
						  <button type="button" class="btn btn-default pull-rigth" onclick="memCancel();"><span class='fa fa-fw fa-close'></span>&nbsp;취소</button>
                		  <button type="button" class="btn btn-default pull-rigth" style="margin-rigth:1%;" id="memSelect"><span class="glyphicon glyphicon-send"></span>&nbsp;선택</button>         		
              			</div>
					</div>
				</div>
		...
		<div class="modal fade" id="mssInfo" role="dialog"  role="dialog" data-toggle="modal" data-backdrop="static" data-keyboard="false">
			<div class="modal-dialog modal-lg">
				...
				<div class="modal-content">
              	...
              	<div class="form-group">
              		<label class="control-label col-sm-2" for="title" style="text-align: right;">수신자 :</label>
