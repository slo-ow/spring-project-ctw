		    	...
		    	success:function(res){
		    		...
		    		$.each(res,function(i,v){
		    			if(v.doc_extsn == 'excel'){
		    				htmlCode +="<div class='filefloat' id='"+v.mem_id+"'><img src='/ctw/resources/icon/Excel 2013.png' class='down' id='"+v.doc_nm+"/"+v.doc_pk+"'>";
		    				if(v.mem_id == mem_id){
		    					htmlCode +="<span class='deleteFile' id='test1/"+v.doc_pk+"'><b>x</b></span>";
		    				}else{
		    					htmlCode +="<span class='deleteFile' ></span>";
		    				}
